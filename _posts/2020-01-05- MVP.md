...
`Repository 패턴`에서 우리는 View가 많은 역할을 하고 있는 것을 볼 수 있었습니다.
View는 단순히 data in/out의 역할만을 수행해야하는데, 그 이상의 기능을 담당하고 있었어요. View에서 Model에 직접적으로 접근을 해서 데이터를 받아오고, 로직에 따라 데이터를 뿌려주는 등의 역할을 해 왔습니다.
...
![image-20200125035027072](/Users/yangseunghui/Library/Application Support/typora-user-images/image-20200125035027072.png)
