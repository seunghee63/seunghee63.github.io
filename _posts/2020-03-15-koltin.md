...
- 젯브레인(JetBrains)에서 만든 언어 (인텔리제이라는 툴로 유명!)
- 2011최초공개, 2016년 정식버전 출시
- 간결한 문법, 풍부한 기능, 높은 안전성 → 높은 생산성 보장
- 자바와 100% 호환
- 2017년 구글 I/O에서 안드로이드 공식 언어로 채택

## 1.2 코틀린의 특징

---

코틀린과 자바의 차이점. 어떤 점이 자바보다 나은지 알아보자!
